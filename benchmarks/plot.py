...
MULTI = {
    ...
    "Fashion-MNIST": [81.0, 85.9, 85.4, 90.2, 90.0, 90.3, 90.6, 90.6, 89.7],
    "CIFAR-10": [39.6, 47.8, 45.6, 52.7, 51.0, 58.5, 58.4, 58.5, 52.7],
}
MULTI_TIME = {
    "MNIST": [2, 2, 3, 318, 378, 241, 402, 464, 83],
    "Fashion-MNIST": [2, 2, 3, 309, 369, 241, 401, 464, 81],
    "CIFAR-10": [14, 3, 3, 332, 356, 315, 457, 480, 141],
}
