...
MULTI = {
    "MNIST": [85.3, 95.6, 95.1, 98.5, 98.6, 98.4, 98.6, 98.6, 98.1],
    "Fashion-MNIST": [81.0, 85.5, 85.5, 90.0, 90.1, 90.3, 91.0, 90.6, 90.2],
    "CIFAR-10": [39.6, 47.8, 45.8, 51.7, 51.0, 57.8, 58.1, 58.5, 54.6],
}
MULTI_TIME = {
    "MNIST": [2, 2, 3, 315, 371, 240, 412, 470, 84],
    "Fashion-MNIST": [2, 2, 3, 316, 376, 239, 410, 463, 82],
    "CIFAR-10": [14, 3, 3, 343, 373, 319, 475, 497, 142],
}
